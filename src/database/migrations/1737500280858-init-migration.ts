...
export class InitMigration1737500280858 implements MigrationInterface {
    name = 'InitMigration1737500280858'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`bibliography-types\` (\`id\` int NOT NULL AUTO_INCREMENT, \`uuid\` varchar(36) NOT NULL, \`createdAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6), \`updatedAt\` datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6) ON UPDATE CURRENT_TIMESTAMP(6), \`deletedAt\` datetime(6) NULL, \`description\` varchar(100) NOT NULL, \`state\` enum ('ACTIVE', 'INACTIVE') NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
