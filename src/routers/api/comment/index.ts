...
router.post('/', upload.single('file'), validateDTO(CreateCommentDTO), createCommentController)
router.patch('/:uuid', upload.single('file'), validateDTO(UpdateCommentDTO), updateCommentController)
router.delete('/:uuid', validateDTO(UuidDTO, 'params'), deleteCommentController)
